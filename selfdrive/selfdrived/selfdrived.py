...
class SelfdriveD:
  ...
  def update_events(self, CS):
    ...
    if not self.CP.radarUnavailable and not self.sm.valid['radarState']:
      if self.sm['radarState'].radarErrors.canError:
        print("EventName.canError", self.sm['radarState'].radarErrors)
        self.events.add(EventName.canError)
      elif self.sm['radarState'].radarErrors.radarUnavailableTemporary:
        self.events.add(EventName.radarTempUnavailable)
        print("EventName.radarTempUnavailable", self.sm['radarState'].radarErrors)
      else:
        self.events.add(EventName.radarFault)
        print("EventName.radarFault", self.sm['radarState'].radarErrors)
